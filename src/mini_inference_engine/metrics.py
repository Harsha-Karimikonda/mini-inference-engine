...
PREFIX_CACHE_HITS = Counter("mini_prefix_cache_hits_total", "Requests hitting prefix KV cache")
PREFIX_CACHE_MISSES = Counter("mini_prefix_cache_misses_total", "Requests missing prefix KV cache")
PREFIX_CACHE_SAVED_TOKENS = Counter("mini_prefix_cache_saved_tokens_total", "Tokens saved via prefix cache")
